...
# Authentication 
s.login("sreejitth1498@gmail.com", "sree@1498") 
...
data = ResumeParser('C:/Users/Arun/Desktop/ARUN_RESUME1.pdf').get_extracted_data()
print(data)
# grab the name
name = data['name']
# grab the Email
...
if(len(Skills_matched) >= 4 ):
    ...
    message  = 'Subject: {}\n\n{}'.format(SUBJECT, TEXT)
    #send the mail
    s.sendmail("sreejitth1498@gmail.com", email, message) 
    #quit the session
    s.quit()    
else:
